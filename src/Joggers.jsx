...
function Men() {
    ...
    async function fetchProducts() {
        try {
            const response = await fetch('https://academics.newtonschool.co/api/v1/ecommerce/clothes/products?filter={"subCategory": "jogger"}', {
                method: 'GET',
                headers: {
    ...
    return (
        <div className="men-container">
            ...
            <section className="men-clothes">
                <p className="heading-men">Joggers</p>
                <div className="for-shirts-pants">
                    {/* Implement product carousels for different categories */
                        featuredProducts
                            .filter((product) => product.gender === 'Men') // Filter products by gender
                            .map((product) => (
                                <div key={product._id}>
